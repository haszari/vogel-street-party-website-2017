...
export default [
   ...
   {
      title: "Equilibrist",
      blurb: "\"Equilibrist\” is a light projection installation custom mapped for Vogel Street Party 2016, and will run simultaneously with the live premiere of the work being performed in Bern, Switzerand. Parameters set by screens, cameras, projectors and mapping technologies alter how the human body is perceived in space and in time. A type of cinematic collage transforms, retimes and realigns itself during digital transmission. ",
      allDay: false, 
      start: "9:00 pm",
      end: "10:00 pm",
